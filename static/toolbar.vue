...
-->
<template>
  <b-navbar type='is-info' style="background-color: #e60000; box-shadow: 0 3px 3px 0 lightgrey">
    <template slot="brand">
      <b-navbar-item style="font-size:24px" href="/">
        <img src="https://www.excaliburcomms.co.uk/wp-content/uploads/Vodafone-logo-300x300.png">
      </b-navbar-item>
    </template>
    <template slot="start">
